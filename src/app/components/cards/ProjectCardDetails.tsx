...
export function ProjectCardDetails(props: ProjectsProps) {
  ...
  return (
    <Card className="bg-card h-[90vh] w-[80vw] border-none rounded-[2rem] p-2">
      <CardContent className="flex m-3 h-full w-full">
        ...
        <div className="w-full h-full p-2">
          ...
          <ScrollArea className="border-solid border-2 h-[30vh] w-full rounded-2xl p-2 bg-content">
            <p className="m-1">{project.description}</p>
          </ScrollArea>
          <p className="text-2xl mt-2">Comments</p>
          <ScrollArea className="border-solid border-2 h-[40vh] w-full rounded-2xl p-2 bg-content">
