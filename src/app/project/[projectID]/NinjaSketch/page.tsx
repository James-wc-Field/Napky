...
import { DndContext, PointerSensor, TouchSensor, pointerWithin, useSensor, useSensors } from "@dnd-kit/core";
  ...
  return (
    <div>
      ...
      <DndContext id={id} sensors={sensors} collisionDetection={pointerWithin}>
        <AppCanvas handleMouseMove={handleMouseMove} handleMouseDown={handleMouseDown} handleMouseUp={handleMouseUp} />
      </DndContext>
    </div>
  );
}
